...
based on Business Casual theme by Start Bootstrap

## How to use in Orchard Core
Create an empty ASP.NET Core web application.
Reference OrchardCore.Application.Cms.Targets (from myget preview feed)
Change the startup.cs class to AddOrchardCms() and UseOrchardCore()
Reference this repo's nuget package (CafeTheme.OrchardCore)
Run, choose Cafe recipe and presto, the site should appear!
